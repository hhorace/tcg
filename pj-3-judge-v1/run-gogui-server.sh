...
# command to launch
# player='../proj3/nogo --shell --name="medium" --black="mcts T=1000 exp=1.25" --white="mcts T=1000 exp=1"'
player='../proj3/nogo --shell --name="medium" --black="mcts exp=1.25" --white="mcts exp=1"'
# port for binding
port=${1:-auto}
